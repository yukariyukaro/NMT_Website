...
const MUSIC_CATALOG: MusicTrack[] = [
  {
    ...
    recommendedVideoCategories: ["呼吸训练", "言语训练"],
  },
  {
    id: "red-sun",
    title: "红日",
    ...
    recommendedVideoCategories: ["呼吸训练", "步态训练"],
  },
  {
    id: "love-is-eternal",
    title: "爱是永恒",
  ...
  },
  {
    ...
    recommendedVideoCategories: ["步态训练", "上肢训练"],
  },
  {
    id: "boundless-oceans",
    title: "海阔天空",
  ...
  },
  {
    ...
    difficulty: "intermediate",
    trainingTypes: ["RAS", "TIMP"],
    recommendedVideoCategories: ["步态训练", "下肢训练"],
  },
  {
    id: "heart-debt",
    title: "心债",
    ...
    difficulty: "intermediate",
    trainingTypes: ["RAS", "TIMP"],
    recommendedVideoCategories: ["步态训练"],
  },
  {
    id: "chase",
    title: "追",
